...
export default function FormulaireSuggestionAchat() {
  ...
  if (success) {
    return (
      <section style={{ maxWidth: "600px", margin: "2rem auto", padding: "2rem", background: "var(--white)", borderRadius: "8px", boxShadow: "0 2px 6px rgba(0,0,0,0.1)", textAlign: "center" }}>
        ...
        <p style={{ fontSize: "1rem", color: "var(--gris-700)", marginBottom: "2rem" }}>
        ...
        <div>
          ...
          <a href="/" style={{ background: "var(--gris-500)", color: "var(--white)", padding: "10px 20px", borderRadius: "30px", textDecoration: "none" }}>
            Retour à l’accueil
          </a>
        </div>
      </section>
  ...
  return (
    <section style={{ maxWidth: "700px", margin: "2rem auto", padding: "1rem", background: "var(--white)", borderRadius: "8px", boxShadow: "0 2px 6px rgba(0,0,0,0.1)" }}>
      ...
      <p style={{ marginBottom: "1rem", fontSize: "0.9rem", color: "var(--gris-600)" }}>
      ...
      <form onSubmit={submit}>
        ...
        {/* Messages d’état */}
        {status && (
          <div style={{ margin: "1rem 0", padding: "0.75rem", background: "var(--gris-50)", borderRadius: "4px" }}>
            {status}
          </div>
        )}
