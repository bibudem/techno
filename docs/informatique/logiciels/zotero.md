...
### Extension Zutilo
**L'extention Zutilo n'est présentement pas compatible avec la version la plus récente de Zotero (version 9) sortire en avril 2026, la mise èa jour de ce plugin prend habituellement 3-4 mois.**
