...
<Tabs groupId="os">
  <TabItem value="macos" label="macOS">
    ...
    **Utiliser le navigateur internet Safari, Chrome ou Firefox.**
...
<Tabs groupId="os">
  <TabItem value="macos" label="macOS">
    ...
    4. Si le problème persiste, **redémarrer l'ordinateur** et essayer à nouveau.
